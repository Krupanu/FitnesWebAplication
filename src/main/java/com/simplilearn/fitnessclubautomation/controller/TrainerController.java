...
public class TrainerController {
    ...
    private Trainer addTrainer(@RequestParam(value = "trainer_name", required = true) String trainer_name,
    ...
    private Trainer editTrainer(@RequestParam(value = "trainer_id", required = true) Long trainer_id,
    ...
    private Boolean deleteTrainer(@RequestParam(value = "trainer_id", required = true) Long trainer_id
